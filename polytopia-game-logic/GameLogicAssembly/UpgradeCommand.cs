...
public class UpgradeCommand : CommandBase
{
	...
	public UpgradeCommand(byte playerId, UnitData.Type type, WorldCoordinates coordinates)
		: base(playerId)
	{
		Type = type;
	...
	public override void Execute(GameState state)
	{
		...
		if (state.GameLogicData.TryGetData(Type, out var data))
		{
			state.ActionStack.Add(new UpgradeAction(base.PlayerId, Type, Coordinates, data.cost));
		}
	}
