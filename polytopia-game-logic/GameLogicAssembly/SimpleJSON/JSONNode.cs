...
public abstract class JSONNode
{
	...
	protected const char INDENTATION_CHAR = '\t';

	protected const string KEY_VALUE_SEPARATOR = ": ";
	...
	private static void ParseElement(JSONNode ctx, string token, string tokenName, bool quoted)
	{
		...
		if (double.TryParse(token, NumberStyles.Float | NumberStyles.AllowThousands, CultureInfo.InvariantCulture, out var result))
		{
