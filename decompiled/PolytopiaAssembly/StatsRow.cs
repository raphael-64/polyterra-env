...
public class StatsRow : UIButtonBase
{
	public const string STATS_ROW_PADDING = ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . ";

	public const string DIPLOMACY_INCOME_SPACE = "<space=70m>";
	...
	[SerializeField]
	protected RectTransform eloButton;
	...
	public string StatsName
	{
		...
		set
		{
			string arg = (EmbassyIncomeContainerVisible ? "<space=70m>" : "");
	...
	protected override void OnDestroy()
	{
		...
		{
			Log.Info("Text coroutine in stats row was destroyed", Array.Empty<object>());
		}
	}
	...
	public void SetTextColor(Color color)
	{
		...
		((Graphic)embassyIncomeText).color = color;
	}
	...
	public void RefreshLayout()
	{
		...
		if ((Object)(object)eloButton != (Object)null && ((Component)eloButton).gameObject.activeInHierarchy)
		{
			width = eloButton.anchoredPosition.x - eloButton.GetWidth() * 0.5f - ((TMP_Text)statsNameLabel).rectTransform.anchoredPosition.x;
		}
		...
		StopTextCoroutine();
		textCoroutine = ((MonoBehaviour)UIManager.Instance).StartCoroutine(SetTextCoroutine());
	...
	public void EnableEloButton()
	{
		if (!((Object)(object)eloButton == (Object)null))
		{
			((Component)eloButton).gameObject.SetActive(true);
			RefreshLayout();
		}
	}

	protected bool StopTextCoroutine()
	{
		if (textCoroutine != null && (Object)(object)UIManager.Instance != (Object)null)
		{
			((MonoBehaviour)UIManager.Instance).StopCoroutine(textCoroutine);
			return true;
		}
		return false;
	}
